...
export default async function handler(req, res) {
    ...
    try {
        ...
        // 1. Dùng phiên bản v1 chuẩn và model gemini-1.5-flash (Khắc phục 100% lỗi 404)
        const url = `https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=${apiKey}`;

        // 2. Viết câu lệnh cực kỳ chặt chẽ để ép model trả về JSON mà không cần config
        ...
        // 3. Payload tối giản: Gộp tất cả vào nội dung Text (Khắc phục 100% lỗi 400 Invalid Payload)
        ...
        // 5. Quét dọn các ký tự thừa (nếu AI lỡ tay thêm markdown)
