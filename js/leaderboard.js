...
// ĐỂ BÊN NGOÀI IIFE VÌ CẦN XUẤT (EXPORT) CHO MODULE KHÁC SỬ DỤNG
...
// =========================================================================
// ĐÓNG GÓI IIFE - CÔ LẬP TRẠNG THÁI & LOGIC KHỎI SỰ CAN THIỆP TỪ CONSOLE F12
// =========================================================================
(() => {
    let globalTopUsers = [];
    let currentPage = 1;
        ...
        if (downloadBtn && !downloadBtn.dataset.listenerAttached) {
            ...
            downloadBtn.addEventListener('click', async () => {
                try {
                    ...
                    podiumElement.style.padding = "40px 20px 85px"; 
    ...
    // SPEEDBUMP: CHẶN CÁC PHÍM TẮT MỞ DEVELOPER TOOLS
